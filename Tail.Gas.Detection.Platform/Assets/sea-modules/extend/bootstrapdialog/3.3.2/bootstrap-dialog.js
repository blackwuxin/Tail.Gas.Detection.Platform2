...
define(function (require) {
	...
	(function (root, factory) {
		...
		BootstrapDialog.DEFAULT_TEXTS['CONFIRM_TITLE'] = 'Confirm';
		...
		BootstrapDialog.prototype = {
			...
			createModalContent: function () {
				/* edit by zcl : add style attribute... */
				return $('<div class="modal-content" style="margin-top:150px;"></div>');
			},
		...
		BootstrapDialog.confirm = function (message, callback) {
			return new BootstrapDialog({
				title: BootstrapDialog.DEFAULT_TEXTS.CONFIRM_TITLE,
				message: message,
				closable: false,
				data: {
					'callback': callback
